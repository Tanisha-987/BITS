              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center gap-2 group-hover:gap-3">
                      <span>Download</span>
            ...
            <div className="bg-gradient-to-br from-primary-50 to-blue-50 rounded-lg p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700">info@abchighschool.edu</span>
                </p>
              </div>
            </div>
