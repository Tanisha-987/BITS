          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+919812526326" className="hover:text-primary-400 transition-colors">+91 9812526326</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-6 text-center animate-fadeInUp" style={{ animationDelay: '500ms' }}>
            <p className="text-gray-400 text-sm space-x-2">
              ...
              <a
                ...
                className="mr-2 text-blue-300 hover:text-blue-200 font-semibold transition-all hover:underline decoration-2 underline-offset-4 inline-flex items-center space-x-2 group"
              >
                <span>Aryan</span>
                <svg
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-300 hover:text-blue-200 font-semibold transition-all hover:underline decoration-2 underline-offset-4 inline-flex items-center space-x-2 group"
              >
                <span>Tanisha</span>
                <svg
                  className="w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform"
